...
const projectsDB = [
    ...
    },
    {
      ...
      description: "Diseño y Desarrollo Front-end",
      description2: "HTML, CSS3 y Javascript",
      image: paz,
      slide01: paz01,
      slide02: paz02
    ...
    {
      id: 107,
      client: "TAYCOM S.A. | Multilogística",
      type: "Imagen Corporativa",
      category: ['all', 'diseno'],
      description2: "Isologo",
      description3: "Branding",
      description4: "Papelería Institucional",
    ...
    {
      id: 112,
      client: "Solpa S.A. | Insumos Médicos",
      type: "Webpage",
      category: ['all', 'web'],
    ...
    {
      id: 114,
      client: "Vision Interior | Fábrica de Muebles",
      type: "Catálogo de Productos",
      category: ['all', 'diseno'],
      description2: "Diseño de Catálogo", 
      description3: "Formato A4", 
      description4: "28 páginas", 
      description5: "Encuadernado térmico",
      image: vision,
      slide01: vision01,
      slide02: vision02
    },
